...
// compris entre 1 et nb_entité, SAUF pour OBSTACLE_VALUE_INCORRECT et
// MULTI_OBSTACLE
...
// un seul message est destiné à indiquer l'absence d'erreur après la lecture
// complète
...
#define PLAYER_COLLISION(PARAM1, PARAM2)                                       \
  ("Player collision: " + std::to_string(PARAM1) + " with " +                  \
...
// les valeurs PARAM1 et PARAM2 sont respectivement les indices de ligne et
// colonne
...
#define BALL_COLLISION(PARAM1, PARAM2)                                         \
  ("Ball collision: " + std::to_string(PARAM1) + " with " +                    \
   std::to_string(PARAM2))
